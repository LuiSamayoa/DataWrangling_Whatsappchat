...
to_remove <- c(stopwords(language = "en"),
               ...
               c(1:1000),
               c("imagen","sticker","image","omitida","omitted","jajaja","jajajaja","https","voice", "missed", "media", "wuajajajaja", "wuajaja","wajajajajaja","wajajajajajaja","wajajajaja","si","vm.tiktok.com"),
               url_regex)
